...
const painPoints = [
    ...
    },
    {
        ...
        description: 'Semua orang bicara AI. Tapi Anda tidak tahu harus mulai dari mana. Takut kelihatan gaptek,\ntapi juga bingung bagaimana AI bisa benar-benar membantu pekerjaan\nexecutive sehari-hari.'
    }
];
